...
public class ProjectInfoApplication {
    ...
    public void createTftMember() {
        ...
        TftMember member3 = new TftMember("이은지", "N0015", "서버", 17);
        TftMember member4 = new TftMember("김미현", "N0070", "서버", 6);
        TftMember member5 = new TftMember("안유진", "N1009", "서버", 1);
        TftMember member6 = new TftMember("이영지", "N0027", "클라", 19);
        TftMember member7 = new TftMember("도경수", "N0928", "클라", 2);
        TftMember member8 = new TftMember("김우빈", "N0036", "아트", 15);
        TftMember member9 = new TftMember("이광수", "N0703", "아트", 5);
        TftMember member10 = new TftMember("김기방", "N1244", "아트", 1);
        ...
        addSubmitCountForMember(member1, perforce, 14);
        addSubmitCountForMember(member2, perforce, 5);
        addSubmitCountForMember(member3, perforce, 19);
        addSubmitCountForMember(member4, perforce, 7);
        addSubmitCountForMember(member5, perforce, 14);
        addSubmitCountForMember(member6, perforce, 16);
        addSubmitCountForMember(member7, perforce, 3);
        addSubmitCountForMember(member8, perforce, 17);
        addSubmitCountForMember(member9, perforce, 6);
        addSubmitCountForMember(member10, perforce, 10);

        addSubmitCountForMember(member1, jira, 14);
        addSubmitCountForMember(member2, jira, 5);
        addSubmitCountForMember(member3, jira, 19);
        addSubmitCountForMember(member4, jira, 7);
        addSubmitCountForMember(member5, jira, 14);
        addSubmitCountForMember(member6, jira, 16);
