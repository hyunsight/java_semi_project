...
public class School {
    private static String SCHOOL_NAME = "Godd School"; //학교 이름
    ...
    //1. 싱글톤으로 사용할 객체는 private, static 키워드를 붙여서 선언한다. (반드시)
    ...
    //3. 싱글톤 객체를 생성하는 메소드 구현 (가장 중요)
    public static School getInstance() {
        //처음 school 객체가 생성될 때 실행
        if (instance == null) {
            instance = new School();
        }
        // 2번째 이후 school 객체가 생성될 때 실행
        return instance;
    }
